...
> **关联**：[G-L1-需求规格说明书.md](G-L1-需求规格说明书.md) · [G-L1-PRD-v2.md](G-L1-PRD-v2.md) · [G-L3-API契约.md](G-L3-API契约.md) · [G-L3-实施清单.md](G-L3-实施清单.md) · [G-L2-架构设计说明书.md](G-L2-架构设计说明书.md) · **[G-L3-开发进度.md](G-L3-开发进度.md)（git 同步进度表）** · **[G-L3-开发者B任务手册.md](G-L3-开发者B任务手册.md)（B 专用）**
...
| **开发者 B** | 下游 | 让方案能确认、写出稿、发出去、看出效果。专用手册：[G-L3-开发者B任务手册.md](G-L3-开发者B任务手册.md) |
...
> **B 请优先阅读独立手册**：[G-L3-开发者B任务手册.md](G-L3-开发者B任务手册.md)（任务 / I/O / WAIT_FOR 话术已完整抽出）。下文保留便于与 A 对照。
