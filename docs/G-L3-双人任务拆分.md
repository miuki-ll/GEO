...
> **关联**：[G-L1-需求规格说明书.md](G-L1-需求规格说明书.md) · [G-L1-PRD-v2.md](G-L1-PRD-v2.md) · [G-L3-API契约.md](G-L3-API契约.md) · [G-L3-实施清单.md](G-L3-实施清单.md) · [G-L2-架构设计说明书.md](G-L2-架构设计说明书.md)
...
[ ] 若任务完成且有 NOTIFY：我已提示对方可开始的任务号
[ ] 若宣称联调/AC 通过：我已核对对应 GATE G1–G5
```

---

*G-L3-双人任务拆分 v1.1 · 增加 WAIT_FOR/NOTIFY/GATE 与 Agent 提示话术 · 对齐 PRD/需求规格 v2.1 + API 契约 v2.1*
